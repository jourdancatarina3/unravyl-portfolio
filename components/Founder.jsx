    ...
    <section className="flex items-center relative justify-center flex-col mt-[5rem]">
      ...
      <div className="flex items-center gap-5 w-3/4 mt-[5rem] justify-center">
        {projects.map((proj) => (
          <div
            key={proj.name}
            className="bg-[#828192] w-1/2 rounded-xl flex items-center flex-col justify-center"
          >
            <div className="image-container   rounded-t-2xl flex items-center mt-[0.7rem] justify-center">
              <Image
                src={proj.img}
                alt={proj.name}
                height={1450}
