...
function Hero() {
  return (
    <section className="w-full flex flex-col h-[50rem] items-center justify-start relative">
      ...
      <div className=" flex  flex-col mt-[4rem] items-center justify-center text-[7rem] font-black">
        <h1>FREELANCE</h1>
        <h1>WEB</h1>
        <h1>DEVELOPERS</h1>
      </div>
      ...
      <div className="w-[11rem] py-3 absolute flex items-center text-xl justify-center bottom-0 rounded-xl text-white bg-[#83828A]">
